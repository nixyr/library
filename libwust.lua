...
tuggle.Name = "Toggle"
tuggle.Parent = LuxtLib
tuggle.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
...
--Heading Size
  sideHeading.Size = UDim2.new(0, 155, 0, 40)

--Username, HubName Size
  usename.Size = UDim2.new(0, 110, 0, 50)
  hubName.Size = UDim2.new(0, 110, 0, 25)

--Visible or fLse
  framesAll.Visible = false
  tabFrame.Visible = false
  minimized = true

  else
    shadow:TweenSize(
    UDim2.new(0, 609, 0, 400),
    Enum.EasingDirection.Out,
    Enum.EasingStyle.Quart,
    .5,
    true
...
framesAll.Size = UDim2.new(0, 381, 0, 320)
framesAll.ZIndex = 2
...
shadow.Size = UDim2.new(0, 609, 0, 400)
shadow.ZIndex = 0
